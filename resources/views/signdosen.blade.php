...
<body>
  <div class="container2">
    <img src="img/amikom-logo.svg" alt="Logo Amikom" class="logo">
  </div>
    <div class="container">
        <form action="{{ route('signdosen.store') }}" method="POST">
        @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" id="NIK_dosen" name="NIK_dosen" placeholder="Enter your nik" required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" id="nama_dosen" name="nama_dosen" placeholder="Enter your nama" required>
          </div>
          ...
          <input class="login" type="submit" value="Daftar">
        </form>
        @if(session('success'))
...
@endif
        <p class="text-center">Sudah Punya Akun? <a href="/login">Log In</a></p>
      </div>
      <script>
